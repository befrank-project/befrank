...
// Copyright (c) 2016-2017, BeFrank developers
//
...
private:
	...
	bool on_getbalance(const wallet_rpc::COMMAND_RPC_GETBALANCE::request& req, wallet_rpc::COMMAND_RPC_GETBALANCE::response& res);
